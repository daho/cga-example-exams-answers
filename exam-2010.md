...
Die Textur wird in verschiedenen Auflösungen gefiltert vorberechnet. Je nach Verzerrungsverhältnis, wird die entsprechende Textur gewählt und angewandt.
Heutzutage standardmäßig in Hardware vorhanden.
...
Die UV-Parametrisierung gibt an, welcher Texel auf einen pixel gemapped wird. uv ist die Position auf der Textur(Bild) die auf den Pixel im Objekt gezeichnet wird.
